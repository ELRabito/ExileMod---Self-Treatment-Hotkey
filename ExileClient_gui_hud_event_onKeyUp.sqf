...
// RW_SelfTreat Start 1
//You can change the actionKeys from "User4" up to "User20"
if (_keyCode in (actionKeys "User15")) exitWith {call ExileClient_system_util_QuickSelfTreat};
// RW_SelfTreat End 1
...
{ 
	...
	// RW_SelfTreat Start 2 (Number row button 8)
	case 0x09:
	{
		call ExileClient_system_util_QuickSelfTreat;
		_stopPropagation = true;
	};
	// RW_SelfTreat End 2 (Number row button 8)
	case 0x11,
	case 0x1E,
	case 0x1F,
	case 0x20:
